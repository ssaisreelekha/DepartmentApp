		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdepartmentappdepartmentapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdepartmentappdepartmentapp-display": {
								"semanticObject": "comdepartmentappdepartmentapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.departmentapp.departmentapp",
									"url": sap.ui.require.toUrl("com/departmentapp/departmentapp")
								}
							}
						}
					}
